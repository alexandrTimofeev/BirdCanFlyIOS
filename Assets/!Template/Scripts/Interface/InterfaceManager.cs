...
public static class InterfaceManager
{
    ...
    {
        CreateScoreFlyingText(scoreChange, point, null, false);
    }

    public static void CreateScoreFlyingText(int scoreChange, Vector3 point, Transform parent, bool isUI)
    {
        CreateScoreFlyingText("", scoreChange, "", point, parent, isUI);
    }
    ...
    public static void CreateScoreFlyingText(string prefix, int scoreChange, string postfix, Vector3 point, Transform parent, bool isUI = false)
    {
        ...
        CreateFlyingText(prefix + scoreChange.ToString() + postfix, color, point, parent, isUI);
    }

    public static void CreateFlyingText(string text, Color color, Vector3 point, Transform parent, bool isUI = false)
    {
